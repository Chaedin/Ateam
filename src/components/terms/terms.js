    ...
    return (
        ...
        <div class="main_container">
            <div class="term_list">
                ...
                <h2>1. 개인정보보호</h2>
                회사의 개인정보처리방침에 대한 이해를 돕기 위하여 회사의 개 인정보취급방침을 참조하시기 바랍니다.
                ...
                본 사이트를 이용한 발주내역과 관련된 정책 및 절차(주문처리, 배송 및 사후처리, 반품 및 교환 등)를 조회하려면, 여기를 클릭하십시오.
                • 배송정보
                ...
                <h2>6. 제한적 이용허락</h2>
                회사는 이용자가 본 사이트에 접속하 여 개인 용도로 본 사이트를 이용할 수 있는 제한적이고 취소가능하며 비독점적인 이용권한을 이용자에게 허용합니다. 이 제한적 이용권한은 (a) 본 사이트
                또는 본 사이트의 일부를 포함하여 프레이밍(frame)하거나 프레이밍 기술을 활용할 수 있는 권리, (b) 본 사이트 또는 본 컨텐츠의 일부 및/또는 전부를 재출판, 재배포, 전송,
                ...
                제일특허법인의 김창세 (C. Leon Kim) 담당자와 이정원 (Jeong Won Lee) 담당자입니다.

                명칭: 제일특허법인 (FirstLaw P.C.)
                주소: 서울 서초구 마방로 60 트러스트타워 (양재동); Trust Tower, 60 Mabang-Ro, Seocho-Ku, Seoul 06775, Korea
                Tel.: +82-2-589-0001, Fax.: +82-2-589-1688
                담장자: 김창세(C. Leon Kim), 이정원(Jeong Won Lee)
